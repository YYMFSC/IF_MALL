...
{
    /// <summary>
    /// 该类主要执行数据库底层访问(需要web.Config中定义OdbcConnString)
    /// </summary>
    public class COracle
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        // public static string ConnString = "DSN=EssDB";//@"Driver={Microsoft Paradox Driver (*.db)};DBQ=E:\ESS\Uploads\KSTDD\T_TDD.DB";

        public static string ConnString = CConfig.GetValueByKey("libraryConnString");
        ...
        public static DataSet CreateDataSet(String strSQL)
        {
            ...
            try
            {
                OracleDataAdapter objCmd = new OracleDataAdapter(strSQL, ConnString);
                objCmd.Fill(ds);
                objCmd.Dispose();
            }
            catch (Exception e)
        ...
        public static OracleDataReader CreateReader(string strsql)
        {
            OracleDataReader da;
            OracleConnection OracleConn = new OracleConnection(ConnString);
            try
            {
                OracleCommand cmdTable = new OracleCommand(strsql, OracleConn);
        ...
        public static string GetStringSingle(String strSQL)
        {
            ...
            try
            {
                ...
                OracleDataReader reader = command.ExecuteReader(CommandBehavior.SingleRow);
