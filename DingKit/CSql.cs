...
{
/// <summary>
/// 该类主要执行数据库底层访问(需要web.Config中定义sqlConnString)
/// </summary>
	public class CSql
	{
        ...
        {
            DataSet dataset = CreateDataSet(SqlString);
        ...
        public static DataSet GetPageDataSet1(string SQL, int Page, int RecsPerPage, string ID, string Sort)
        {
            try
            {
        ...
        /// <param name="Sort">排序字段</param>
        /// <returns>当前页的记录集合</returns>
        public static DataTable GetPageDataTable(string SQL, int Page, int RecsPerPage, string ID, string Sort)
        {
            try
            {
                int iPage = RecsPerPage * (Page - 1);
