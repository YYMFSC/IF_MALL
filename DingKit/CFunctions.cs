...
namespace DingKit
{
	...
	public class CFun
	{
       ...
       /// </summary>
        ...
        /// <returns></returns>
        public static bool isYDPhone(string phone)
        {
            ...
            string str = Left(phone, 3);
            if (str == "134" || str == "135" || str == "136" || str == "137" || str == "138" || str == "139" || str == "158" || str == "159" || str == "157" || str == "150" || str == "151" || str == "187" || str == "188")
            {
                return true;
            }
            else
        ...
        public static string  FormatDate(string strTime)
        {
            try
            {
                DateTime dt = DateTime.Parse(strTime);
        ...
        public static string FormatDateEn(string strTime)
        {
            try
            {
                DateTime dt = DateTime.Parse(strTime);
        ...
        public static string FormatWhere(string attr, string mvalue)
        {
            ...
            {
                mvalue = mvalue.Replace("System.Byte[]", "");
            }
       ...
       /// <returns></returns>
        ...
        /// <param name="pageName">网页名称</param>
        /// <returns></returns>
        public static string GetPageExt(string pageName)
        {
            if (pageName == "")
            {
                return "";
            ...
            if (Arr_str.Length > 0)
            {
                string str = Arr_str[Arr_str.Length - 1];
                string[] Arr_str1;
                Char[] split1 = { '?' };
                Arr_str1 = str.Split(split1);
                return Arr_str1[0];
            }
      ...
      /// <returns>加密后</returns>
        ...
        public static int getWeekDay(DateTime dt)
        {
            ...
            switch (WeekEN)
            {
                case "Monday": WeekBum =1; break;
                case "Tuesday": WeekBum =2; break;
                case "Wednesday": WeekBum = 3; break;
                case "Thursday": WeekBum = 4; break;
                case "Friday": WeekBum = 5; break;
                case "Saturday": WeekBum =6; break;
                case "Sunday": WeekBum = 7; break;
            }
            return WeekBum;
        }

        public static string getWeekDayCN(string strdt)
        {
            string weekCN ="";
            if (!string.IsNullOrEmpty(strdt))
            {
                DateTime week = DateTime.Parse(strdt);
                string WeekEN = week.DayOfWeek.ToString();
        ...
        public static string CleanString(string inputString)
        {
            ...
            //{
            //    inputString = inputString.Replace("System.Byte[]", "");
            //}
            //return inputString;
        ...
        /// <param name="key">关键字</param>
        /// <returns></returns>
        public static string ToImportFont(string str, string key)
        {
            string[] sArray = key.Split(' ');
            string sty = "<font style='color:#FF0000;font-weight:bold;' >";

            foreach (string i in sArray)
            {
                str = str.Replace(i.ToString(), sty + i.ToString() + "</font>");
            }
            ...
            return str.Replace(key, sty + key + "</font>");
        }
             /// <summary>
        /// 字符串关键字加红
        /// </summary>
        ...
        /// <param name="key">关键字</param>
        /// <returns></returns>
        public static string ToImportFontSpan(string str, string key)
        {
            string[] sArray = key.Split(' ');
            string sty = "<span style='color:#FF0000;font-weight:bold;' >";
        ...
        public static string Create8ID()
        {
            ...
            NowTime = DateTime.Now;
            TempYear = NowTime.Year.ToString();
            TempYear = CFun.Right(TempYear, 2);
            TempMonth = NowTime.Month.ToString();
            TempDay = NowTime.Day.ToString();
