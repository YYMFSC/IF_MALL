...
namespace DingKit
{
    ...
    public class CFile
    {
       ...
       /// <returns>是否存在</returns>
        ...
        /// <param name="stfilePath">文件绝对或者相对路径</param>
        /// <returns>文件名</returns>
        public static string GetFileNameWithOutExp(string stfilePath)
        {
            string strTempPath = stfilePath.Replace("/", "，");
            strTempPath = strTempPath.Replace("\\", "，");
            int i = strTempPath.LastIndexOf("，");
        ...
        /// 剪切文件
        /// </summary>
        /// <param name="sourceFileName">原始绝对目录</param>
        /// <param name="targetFileName">目标绝对目录</param>
        ...
        /// <param name="parentDir">目录绝对路径</param>
        /// <param name="subDirName">子目录名称</param>
        public static void CreateDirectoryByPhysicalPath(string parentDir, string subDirName)
        {
            parentDir = System.Web.HttpContext.Current.Request.PhysicalApplicationPath + "/" + parentDir;
            CreateDirectory(parentDir + PATH_SPLIT_CHAR + subDirName);
        }
