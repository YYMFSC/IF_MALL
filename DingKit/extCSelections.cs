...
namespace DingKit
{
    ...
    public class extCSelections
    {
        ...
        /// <param name="mtext">名称字段</param>
        /// <param name="mvalue">编号字段</param>
        public static void LoadSelection(ref ExtAspNet.DropDownList DDL_Items, string tablename, string mtext, string mvalue)
        {
        ...
        /// <param name="ConStr">条件字段</param>
        /// <param name="isTextShowCode">文本带编号显示</param>
        public static void LoadSelection(ref ExtAspNet.DropDownList DDL_Items, string tablename, string mtext, string mvalue, string ConStr, bool isShowWithCode)
        {
            string sqlTxt = "";
            if (isShowWithCode == true)
            {
        ...
        /// <param name="mtext">名称字段</param>
        /// <param name="mvalue">编号字段</param>
        public static void LoadSelection(ref ExtAspNet.CheckBoxList DDL_Items, string tablename, string mtext, string mvalue)
        {
            DDL_Items.DataSource = GetSelections(tablename);
            DDL_Items.Items.Clear();
            //DDL_Items.SelectedIndexArray = -1;
            DDL_Items.DataTextField = mtext;
            DDL_Items.DataValueField = mvalue;
            DDL_Items.DataBind();
        }
        ...
        /// <param name="Value">值</param>
        public static void SetIndex(ref ExtAspNet.CheckBoxList DDL_Items, string Value)
        {
            for (int i = 0; i < DDL_Items.Items.Count; i++)
            {
